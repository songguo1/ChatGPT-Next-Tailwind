...
const variantStyles = {
  ...
  primary:
    "bg-green-500 text-white hover:bg-green-700 hover:text-white shadow-sm disabled:shadow-none disabled:bg-transparent disabled:text-gray-300 dark:disabled:text-gray-600",
};
